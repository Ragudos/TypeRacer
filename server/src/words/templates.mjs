export const templates = [
    ...
    "she {{ verb_past }} at the {{ noun_organization }} {{ date_duration }} ago and never looked back",
    ...
    "{{ noun_organization }} is the best place to {{ verb }}",
    "{{ noun_nonplural }}s are {{ adjective }} at {{ verb }}",
    "she {{ verb_past }} the {{ noun_organization }} {{ date_duration }} ago and loved it",
    ...
    "{{ noun_organization }} is {{ an_adjective }} place to {{ verb }} with friends",
    "{{ noun_nonplural }} {{ verb_past }} at {{ noun_organization }} {{ date_duration }} ago",
	 "{{ noun }} is {{ an_adjective }} place to {{ verb }}",
    "{{ noun_organization }}'s dedication to {{ noun }} is truly {{ adjective }}",
    "the {{ noun_nonplural }} {{ verb_past }} through {{ noun_organization }} {{ date_duration }} ago",
    ...
    "{{ noun_organization }} is known for its {{ adjective }} {{ noun }}",
    "{{ noun_demonyms }}s are {{ adjective }} when it comes to {{ verb }}",
    "she {{ verb_past }} with {{ noun_nonplural }} at {{ noun_organization }} {{ date_duration }} ago",
    ...
    "it's {{ an_adjective }} feeling to {{ verb }} at {{ noun_organization }}",
    "{{ noun_demonyms }}s are {{ an_adjective }} group of people",
    "{{ noun }}s are known for their {{ adjective }} {{ noun }}",
    "she {{ verb_past }} with {{ noun_nonplural }} at {{ noun_organization }} and enjoyed it",
